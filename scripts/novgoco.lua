...
local searchNovelsElement = 'div.row.c-tabs-item__content'
...
function search(searchQuery)
	local url = 'https://novgo.co/?s=' .. searchQuery .. '&post_type=wp-manga'
	local document = lib:getDocument(url)
...
function parseNovel(url)
	...
	local result = lib:executeRequest(request, 'https://www.novgo.co')
